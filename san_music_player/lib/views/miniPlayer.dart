...
class _MiniPlayerState extends State<MiniPlayer> {
            ...
            return Card(
              ...
              child: Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text('No Songs has been playing currently'),
                    subtitle:
                        Text('Please tap on a song from the list to enjoy..'),
                  )),
            );
          },
        );
  ...
  play(MediaItem mediaItem, SharedPreferences prefs) {
    if (!AudioService.running && prefs != null) {
      final items = Provider.of<SongDetailModel>(context, listen: false).items;
